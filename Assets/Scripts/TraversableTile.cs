...
public class TraversableTile : Tile
{
    ...
    public enum OccupiedState { UNKNOWN, UNOCCUPIED, OCCUPIED }
    public enum TTType { UNKNOWN, DOOR_TT, GENERIC_TT }
    ...
    public OccupiedState GetOccupationState() => occupiedState;
    public TTType GetTTType() => ttType;

    public void SetOccupationState(OccupiedState state) => occupiedState = state;
    public void SetTTType(TTType type) => ttType = type;
